...
"""
from refactor_imports.utils.terminalsize import get_terminal_size
...
class ApplicationSettings(object):
    ...
    def _config_files(self):
        """
        Defines the default set of config files to try to use.  The set is ".refactor_importsrc" in the current
