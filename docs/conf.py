# -*- coding: utf-8 -*-
#
# RefactorImports documentation build configuration file, created by
...
project_name = u'RefactorImports'
...
project_description = u'Refactor imports in python source files.'
project_package = u'refactor_imports'
